...
<head>
    ...
    <style>
        ...
        .header { background: linear-gradient(135deg, #4c1d95 0%, #991b1b 100%); color: white; padding: 40px; text-align: center; }
        ...
        h2 { border-bottom: 2px solid #ef4444; padding-bottom: 10px; margin-top: 40px; }
        .summary { background: #fff1f2; border-left: 5px solid #ef4444; padding: 20px; border-radius: 4px; }
...
<body>
    <div class="header">
        <div class="logo-text">AURA OPS // RED HORIZON</div>
    ...
    <div class="footer">Generated by AURA OPS Intelligence Core. Confidential Document.</div>
</body>
</html>
    `;
  };
  ...
  const handleDownloadHTML = () => {
    ...
    a.href = url;
    a.download = `AURA_REPORT_${report.title.replace(/\s+/g, '_')}.html`;
    a.click();
  };
  ...
  const handleDownloadWord = () => {
    ...
    const a = document.createElement('a');
    a.href = url;
    a.download = `AURA_REPORT_${report.title.replace(/\s+/g, '_')}.doc`;
    a.click();
  };
  ...
  return (
    <div className="fixed inset-0 z-[70] bg-black/90 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white rounded-xl w-full max-w-4xl h-[85vh] flex flex-col shadow-2xl overflow-hidden relative">
        <div className="bg-gradient-to-r from-secondary to-primary p-6 flex justify-between items-center text-white">
        ...
        <div className="flex-1 overflow-y-auto bg-gray-100 p-8">
            <div className="bg-white shadow-lg p-10 max-w-2xl mx-auto min-h-[60vh] border border-gray-200 transform scale-95 origin-top">
                <div className="border-b-4 border-primary pb-4 mb-6 flex justify-between items-end">
                    <h1 className="text-3xl font-bold text-gray-800">AUDIT REPORT</h1>
                    <span className="text-primary font-mono text-sm">CONFIDENTIAL</span>
                </div>
                ...
                <div>
                    ...
                    {report.findings.map((f, i) => (
                        <div key={i} className="mb-4 border-l-4 pl-4 py-1" style={{borderColor: f.severity === 'CRITICAL' ? '#991b1b' : '#ef4444'}}>
                            <div className="flex justify-between items-center mb-1">
                                <span className="font-bold text-gray-700 text-sm">{f.title}</span>
                                <span className="text-[10px] text-white px-2 py-0.5 rounded" style={{backgroundColor: f.severity === 'CRITICAL' ? '#991b1b' : '#ef4444'}}>{f.severity}</span>
                            </div>
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200 flex justify-end gap-4">
            ...
            <button onClick={handleDownloadHTML} className="flex items-center gap-2 px-6 py-3 bg-primary text-white rounded-lg font-bold shadow-lg shadow-red-500/20"><Download size={18} /> HTML</button>
        </div>
      </div>
    </div>
  );
